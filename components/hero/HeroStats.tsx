...
const HeroStats: FC<{ stats: Props }> = ({ stats }) => {
  return (
    <div className="grid min-w-full grid-cols-3 items-center gap-[1px] overflow-hidden rounded-lg border-[1px] border-gray-300 bg-gray-300 dark:border-[#525252] dark:bg-[#525252] md:m-0 md:h-[82px] md:min-w-[520px] md:gap-2 md:bg-white dark:md:bg-black">
      <Stat name="items">
        <h3 className="reservoir-h6 md:reservoir-h5 dark:text-white">
      ...
      */}
      <Stat name="floor">
        <h3 className="reservoir-h6 md:reservoir-h5 flex items-center justify-center gap-1 dark:text-white">
